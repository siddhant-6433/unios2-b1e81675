...
export const COURSE_KNOWLEDGE: Record<string, {
  ...
  "GNM": {
    highlights: [
      ...
      "Clinical training at NIMT's own parent hospital on campus PLUS affiliated hospitals — GIMS (Greater Noida), Navin Hospital, Manipal Hospital",
      "Psychiatric postings at VIMHANS Delhi and IHBAS Delhi; community training at CHCs and PHCs",
      "Graduates receive registration from State and Indian Nursing Councils",
    ],
    practicalExposure: "Clinical training at NIMT's on-campus parent hospital and affiliated hospitals including Government Institute of Medical Sciences (GIMS, Greater Noida), Navin Hospital, and Manipal Hospital. Psychiatric postings at VIMHANS (Delhi) and IHBAS (Delhi). Community training at CHCs and PHCs.",
  ...
  "BPT": {
    ...
    practicalExposure: "Clinical training at NIMT's own parent hospital on campus and affiliated hospitals including Government Institute of Medical Sciences (GIMS, Greater Noida), Navin Hospital, and Manipal Hospital. The programme includes 1 year compulsory internship with rotations across Orthopaedics, Neurology, General Surgery, General Medicine, and Physiotherapy departments.",
  ...
  "BMRIT": {
    ...
    practicalExposure: "General X-ray, orthopaedics imaging, paediatric imaging, emergency imaging, mobile imaging, and surgical suite imaging at NIMT's on-campus parent hospital and affiliated hospitals including Government Institute of Medical Sciences (GIMS, Greater Noida), Navin Hospital, and Manipal Hospital.",
  ...
  "OTT": {
    ...
    practicalExposure: "Operation theatre and anaesthesia support training at NIMT's on-campus parent hospital and affiliated hospitals including Government Institute of Medical Sciences (GIMS, Greater Noida), Navin Hospital, and Manipal Hospital.",
  ...
  "D Pharma": {
    ...
    practicalExposure: "Hands-on training in the pharmacy at NIMT's on-campus parent hospital and affiliated hospitals including Government Institute of Medical Sciences (GIMS, Greater Noida), Navin Hospital, and Manipal Hospital, plus retail/community pharmacies. Dispensing, stock management, patient counselling.",
...
// ── Temporal context ────────────────────────────────────────────────────────
// Mirror of web-chat-server/knowledge.ts (this file is an intentional copy —
// the two services build from their own Dockerfile context, so they can't
// share a module without restructuring both deploy units).
//

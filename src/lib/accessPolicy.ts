...
export const STAFF_ROUTE_POLICIES: readonly RoutePolicy[] = [
  ...
  { path: "/refunds", permission: "finance:refund", roles: ["super_admin", "accountant"], staffOnly: true },
  ...
  { path: "/hr-expenses", permission: "hr:expenses_approve", staffOnly: true },
  { path: "/hr-performance", permission: "hr:performance_manage", staffOnly: true },
  ...
  { path: "/hr-settlements", permission: "hr:employees_edit", staffOnly: true },
  { path: "/hr-advances", permission: "hr:expenses_approve", staffOnly: true },
  { path: "/hr-comp-off", permission: "hr:attendance_edit", staffOnly: true },
  { path: "/hr-encashment", permission: "hr:leave_approve", staffOnly: true },
  { path: "/hr-custom-fields", permission: "hr:employees_edit", staffOnly: true },
  { path: "/hr-team", permission: "hr:employees_edit", staffOnly: true },
  { path: "/hr-job-openings", permission: "hr:view", staffOnly: true },
  { path: "/hr-onboarding", permission: "hr:view", staffOnly: true },
  { path: "/hr-recruitment", permission: "hr:view", staffOnly: true },

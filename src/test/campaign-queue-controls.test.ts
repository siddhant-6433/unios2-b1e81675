...
describe("campaign queue controls", () => {
  ...
  it("supports mapped template variables and scheduled campaign starts", () => {
    ...
    expect(marketingPage).toContain("rememberTemplateHeaderMedia");
    expect(marketingPage).toContain("probePublicMediaUrl");
    expect(marketingPage).toContain("waitForWhatsAppDelivery");
    expect(marketingPage).toContain("waTestDelivered");
    expect(marketingPage).toContain("I received it");
    expect(marketingPage).toContain("Header media URL");
    ...
    expect(leadLists).toContain("rememberTemplateHeaderMedia");

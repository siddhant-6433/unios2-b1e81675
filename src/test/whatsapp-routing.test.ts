...
const providerMigration = readFileSync("supabase/migrations/20260618209100_wa_conversations_provider.sql", "utf8");
const channelsMigration = readFileSync("supabase/migrations/20260618209200_whatsapp_channels.sql", "utf8");
const stateMigration = readFileSync("supabase/migrations/20260618205000_whatsapp_conversation_state.sql", "utf8");
const eventsMigration = readFileSync("supabase/migrations/20260618206000_whatsapp_automation_events.sql", "utf8");
const courseBriefMigration = readFileSync("supabase/migrations/20260618207000_course_admission_briefs.sql", "utf8");
const outboundContextMigration = readFileSync("supabase/migrations/20260618208000_whatsapp_outbound_context.sql", "utf8");
const inboundEventsMigration = readFileSync("supabase/migrations/20260618209000_whatsapp_inbound_events.sql", "utf8");

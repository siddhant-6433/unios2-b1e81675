...
const OptOuts              = lazy(() => import("./pages/OptOuts"));
...
const FeeNotifications     = lazy(() => import("./pages/FeeNotifications"));
                ...
                <StaffRoute>
                  ...
                  <AppLayout>
                    <Routes>
                      ...
                      {/* Collections is now the Receipts tab inside Finance — one list, not two. */}
                      <Route path="/collections" element={<Navigate to="/finance?tab=receipts" replace />} />
                      ...
                      <Route path="/refunds" element={<Navigate to="/finance?tab=refunds" replace />} />

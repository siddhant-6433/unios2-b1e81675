...
const BUCKET_META: Record<Bucket, { label: string; tone: string; icon: LucideIcon }> = {
  ...
  unreplied_whatsapp:   { label: "WA unreplied",      tone: "bg-indigo-100 text-indigo-800 border-indigo-300",          icon: MessageSquareWarning },
...
const UpdeledSprint = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Sprint summary card */}
      <Card className="border-indigo-300 bg-gradient-to-r from-indigo-50 to-amber-50">
            ...
            <div className="flex gap-6 items-center">
              {isCounsellor && stats && (
                <div className="text-right">
                  ...
                  <div className="h-1.5 w-32 bg-indigo-100 rounded mt-1 overflow-hidden">
                    <div className="h-full bg-indigo-500" style={{ width: `${ownProgress}%` }} />
                  </div>
            ...
            scope === "mine" && (stats?.pool_remaining ?? 0) > 0 ? (
              <div className="p-10 text-center text-muted-foreground">
                ...
                <div className="mt-3 flex items-center justify-center gap-2">
                  <Button size="sm" onClick={() => setScope("all")} className="bg-indigo-600 hover:bg-indigo-700 text-white">
                    Show whole pool
                  </Button>
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:bg-muted/40 transition-colors ${
                      flashLeadId === r.lead_id ? "bg-indigo-200/70 border-l-2 border-indigo-600"

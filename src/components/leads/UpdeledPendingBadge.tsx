...
export function UpdeledPendingBadge({ leadId, leadName, phone, courseName, registeredOverride, onRegistered }: Props) {
  ...
  if (registered) {
    ...
    return (
      <span
        className="inline-flex items-center gap-1 rounded-full bg-indigo-100 text-indigo-800 border border-indigo-300 px-2 py-0.5 text-[10px] font-semibold"
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 rounded-full bg-indigo-100 text-indigo-900 border border-indigo-300 hover:bg-indigo-200 px-2 py-0.5 text-[10px] font-semibold transition-colors"

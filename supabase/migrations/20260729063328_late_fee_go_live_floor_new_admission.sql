...
-- version=20260729063328 name=late_fee_go_live_floor_new_admission applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

ALTER TABLE public.late_fee_policies ADD COLUMN IF NOT EXISTS accrual_start_date date;

...
-- version=20260725044350 name=add_school_coordinator_permissions_and_rls applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

-- Copy every office_assistant default permission to school_coordinator
...
-- Expand has_role: school_coordinator inherits all office_assistant RLS checks.
...
-- Update admin_user_directory role-ordering arrays to include school_coordinator

...
('BED-GN', '2 Years (Annual System)', 'Arts/Science/Humanities graduates: min 50% (45% SC/ST). B.E./B.Tech: min 55%.', 'UP B.Ed Joint Entrance Examination (JEE B.Ed UP).', 'Chaudhary Charan Singh University | National Council for Teacher Education', 'No Restriction', '100', 'Any Graduate', '51,250'),
('BED-GZ', '2 Years (Annual System)', 'Arts/Science/Humanities graduates: min 50% (45% SC/ST). B.E./B.Tech: min 55%.', 'UP B.Ed Joint Entrance Examination (JEE B.Ed UP).', 'Chaudhary Charan Singh University | National Council for Teacher Education', 'No Restriction', '100', 'Any Graduate', '51,250'),
('BED-KT', '2 Years (Semester System - 4 Semesters)', 'Arts/Science/Humanities graduates: min 50% (45% SC/ST). B.E./B.Tech: min 55%.', 'PTET', 'University of Rajasthan | National Council for Teacher Education', 'No Restriction', '100', 'Any Graduate', '27,000'),

...
-- version=20260708183606 name=walk_in_dedupe_last10 applied_by=siddhant@nimt.ac.in
...
-- comparison misses and the INSERT hits the unique constraint. Compare on
-- the LAST 10 DIGITS. Caught by ship-time verification check 5.

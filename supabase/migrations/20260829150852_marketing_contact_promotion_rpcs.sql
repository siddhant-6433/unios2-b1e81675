...
-- version=20260829150852 name=marketing_contact_promotion_rpcs applied_by=siddhant@nimt.ac.in
...
GRANT EXECUTE ON FUNCTION public.import_marketing_contacts_bulk(uuid, jsonb, text)                     TO service_role;

...
-- version=20260712080756 name=student_archive_delete applied_by=siddhant@nimt.ac.in
...
BEGIN
  ...
  SET archived_at = now(), archived_by = auth.uid(), archive_reason = _reason, status = 'inactive'

...
-- version=20260821075012 name=hr_executive_perms_documents_interviews applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

-- HR Executive: permissions, document approval workflow, interviews, recruitment RLS.

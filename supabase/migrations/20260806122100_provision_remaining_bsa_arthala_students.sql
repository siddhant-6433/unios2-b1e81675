-- Bill the remaining inactive Arthala (GZ1) students too — per owner request,
-- every BSA student gets monthly tuition regardless of status. Same insert-only,
-- idempotent materialisation as the active backfill; just no status filter.

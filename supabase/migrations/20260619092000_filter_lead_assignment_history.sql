-- Add server-side filters for the lead assignment history view.
-- The visibility scope remains inside the SECURITY DEFINER function.

DROP FUNCTION IF EXISTS public.get_lead_assignment_history(int, uuid);

...
-- version=20260906090050 name=fee_refunds applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

-- Fee refunds: refund collected money against specific receipts / fee heads.
-- Mirrors the video_bills payout lifecycle; each line points at a
-- fee_ledger_payments row, capped at collected minus prior refunds.

-- 1. Permission: finance:refund
...
-- 7. On paid -> ledger reversal, once

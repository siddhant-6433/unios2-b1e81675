...
-- version=20260801153744 name=cashier_fee_charges_and_concessions applied_by=siddhant@nimt.ac.in
...
COMMENT ON COLUMN public.lead_payments.fee_code_id IS
  'Fee head this receipt was collected against. Set by the cashier desk for ad-hoc charges (and any offline receipt); NULL for gateway/legacy rows.';

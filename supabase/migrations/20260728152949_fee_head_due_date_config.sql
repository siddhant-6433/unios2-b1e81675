...
-- version=20260728152949 name=fee_head_due_date_config applied_by=siddhant@nimt.ac.in
...
ALTER TABLE public.fee_structure_items DROP CONSTRAINT IF EXISTS fee_structure_items_due_month_chk;
ALTER TABLE public.fee_structure_items ADD CONSTRAINT fee_structure_items_due_month_chk

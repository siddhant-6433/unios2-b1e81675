...
-- version=20260728154948 name=fee_head_precise_due_date applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

ALTER TABLE public.fee_structure_items ADD COLUMN IF NOT EXISTS due_date date;

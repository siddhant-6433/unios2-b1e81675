...
-- version=20260807134540 name=library_strip_et_al_authors applied_by=siddhant@nimt.ac.in
...
DECLARE v_clean text; v_norm text; v_id uuid;
BEGIN
  ...
  SELECT id INTO v_id FROM public.library_authors

-- Add has_inbound flag to whatsapp_conversations view
-- Inbox shows only conversations with inbound messages (active engagement)
-- Outbound shows conversations with only outbound messages (pending reply)

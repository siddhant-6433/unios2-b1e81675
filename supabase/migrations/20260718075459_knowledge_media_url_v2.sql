...
-- version=20260718075459 name=knowledge_media_url_v2 applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

-- Add media_url to admissions_ai_reply_examples
...
-- Drop and recreate match RPC with media_url in return type

-- Restore the guarded disposition writer after the B.Sc Nursing qualifier
-- migration accidentally reintroduced the older "always complete follow-ups"
-- body. The current signature stays intact, including CNET/CAHET qualifier
-- params, but `not_answered` keeps the pending follow-up open and reschedules
-- it instead of marking it completed.

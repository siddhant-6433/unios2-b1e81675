...
-- version=20260814165928 name=hiring_comms_templates applied_by=siddhant@nimt.ac.in
...
COMMENT ON COLUMN public.email_templates.from_email IS
  'Overrides EMAIL_FROM for this template. HR mail leaves from hr@nimt.ac.in so a candidate replying reaches HR rather than Admissions.';
...
UPDATE public.email_templates SET from_email = 'hr@nimt.ac.in'

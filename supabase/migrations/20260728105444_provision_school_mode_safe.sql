...
-- version=20260728105444 name=provision_school_mode_safe applied_by=siddhant@nimt.ac.in
...
BEGIN
  ...
  -- (a) Provision ledger from fee_structure_items — NON-SCHOOL ONLY (SQL path is
  -- mode-unaware; school heads come from the mode-aware edge fn / recompute).

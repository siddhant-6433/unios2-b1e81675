...
-- version=20260727134125 name=include_pre_admission_token_in_fee_status_v2 applied_by=siddhant@nimt.ac.in
-- Git must keep this timestamp so `db push` matches remote history.

-- Fix: lead_fee_status was missing 'pre_admission_token' in type filters.
-- The 20260707 migration that added this type never deployed to prod.
